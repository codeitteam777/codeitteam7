...
실험 3에서 도출된 두 가지 후보 조합을 최종 Test 셋에서 검증:

- **가설 A (mAP/효율 기준)**: `lr=0.0005, mosaic=0.5, hsv_s=0.2, hsv_v=0.4`
- **가설 B (Loss/안정성 기준)**: `lr=0.003, mosaic=0.0`

**최종 검증 결과**: 가설 B 조합이 **Test mAP 0.9808**과 **Val Loss 1.04**를 달성하며 '성능'과 '안정성' 모두에서 가장 우수함을 입증.
